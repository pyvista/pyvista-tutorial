...
#
#     <center>
#       <a target="_blank" href="https://colab.research.google.com/github/pyvista/pyvista-tutorial/blob/tutorial/notebooks/01_basic/exercises/a_load_examples_exercise.ipynb">
