...
articles = dict(
    ...
    pyvista_artworks=Example(
        title="Stﾃｩphane Laurent's artwork",
        description="Stﾃｩphane Laurent's blog showing a sample of the animations they realized with PyVista.",
...
.. tip::
    ...
    This section of the tutorial was adopted from <https://docs.pyvista.org/getting-started/external_examples.html>
